            ...
            <h1 className={styles.heroTitle}>
              {content.hero.titleLines.map((line, index) => (
                <span key={index} className={styles.heroLine}>
                  {line}
                  {index === content.hero.titleLines.length - 1 && (
          ...
          <div className={styles.heroImage}>
            ...
            <div className={styles.heroImageCaption}>
              <span className={styles.captionLabel}>
                {content.hero.currentPosition.label}
              </span>
              <span className={styles.captionText}>
                {content.hero.currentPosition.text}
              </span>
            </div>
            <div className={styles.locationBadge}>
              ...
              <div className={styles.locationText}>
                ...
                {/* <span className={styles.locationCoords}>
                  {content.hero.coordinates.latitude} /{" "}
                  {content.hero.coordinates.longitude}
                </span> */}
              </div>
            </div>
          </div>
      ...
      <section className={styles.about} data-section="1">
        <div className={styles.aboutGrid}>
          ...
          <div className={styles.aboutContent}>
            <p className={styles.aboutLead}>{content.about.leadParagraph}</p>
            <p className={styles.aboutBody}>{content.about.bodyParagraph}</p>
        ...
        <div className={styles.workInner}>
          <div className={styles.workHeader}>
            <div className={styles.workLabel}>
              <span className={styles.sectionNum}>
                {content.work.sectionNum}
              </span>
              <span className={styles.sectionTitle}>
                {content.work.sectionTitle}
              </span>
            </div>
          ...
          <div className={styles.workGrid}>
            {projects.length > 0 ? (
              projects.map((project, index) => (
                ...
                >
                  <div className={styles.workCardNum}>
        ...
        <div className={styles.blogInner}>
          <div className={styles.blogHeader}>
            <div className={styles.blogLabel}>
              <span className={styles.sectionNum}>
                {content.blog.sectionNum}
              </span>
              <span className={styles.sectionTitle}>
                {content.blog.sectionTitle}
              </span>
            </div>
            ...
            {posts.map((post, index) => (
              ...
              >
                <div className={styles.blogCardMeta}>
                  <span className={styles.blogCardNum}>
                    {String(index + 1).padStart(2, "0")}
                  </span>
      ...
      <section className={styles.contact} data-section="4">
        <div className={styles.contactContent}>
          ...
          <h2 className={styles.contactTitle}>
            {content.contact.headingLines[0]}
            <br />
            <span className={styles.accent}>
              {content.contact.headingLines[1]}
            </span>
          </h2>
          <p className={styles.contactText}>{content.contact.description}</p>
